...
{
    public class SheepSprite : Animal
    {
        ...
        {
            texture = content.Load<Texture2D>("Animals/Sheep_animation_without_shadow");
        }

        public SheepSprite(SoundEffect scaredSound)
        {
        ...
        public override void Update(GameTime gameTime, int screenWidth, int screenHeight, Vector2 playerPosition)
        {
            ...
            // Keep in bounds
            int spriteSize = 32; // Sheep sprite is 32x32
            if (PenBounds != null)
            {
